...
```{r echo=FALSE, eval=nzchar(AnVIL::gcloud_project())}
...
```{r echo=FALSE, error=TRUE, eval=nzchar(AnVIL::gcloud_project())}
...
```{r eval=nzchar(AnVIL::gcloud_project())}
...
```{r error=TRUE, eval=nzchar(AnVIL::gcloud_project())}
