...
[AnVIL training guides]: https://anvilproject.org/learn

## Citing *AnVILWorkflow*
...
Check whether your system has the installation with `GCPtools::gcloud_exists()`.
