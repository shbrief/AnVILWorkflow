...
Below we checked the outputs from [the public repository][] we cloned at
the beginning.

[the public repository]: https://anvil.terra.bio/#workspaces/bioconductor-rpci-anvil/Bioconductor-Workflow-DESeq2

```{r error=TRUE}
## Output from the aborted submission
output_from_aborted <- getOutput(workspaceName = "Bioconductor-Workflow-DESeq2",
                                 submissionId = "ce27a96f-f85f-4aed-9cd1-8b1fc9be1612")
