...
# Setup
## Environment
This package requires `gcloud`. If you don't have it installed yet, following
the below installation snippet:
...
```{r echo=FALSE}
HSM7J4NY_dir <- "/Users/sehyunoh/Packages/RunTerraWorkflow/inst/extdata/outputs/HSM7J4NY"
```
