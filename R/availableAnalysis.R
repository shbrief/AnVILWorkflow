...
#'
#' @return A data frame. The \code{analysis} columns shows the name of the available
#' analyses, which is the required input (\code{analysis} argument) for the functions
#' implemented in RunTerraWorkflow package.
#'
#' @examples
#' availableAnalysis()
#'
