...
get_workflows <- function(holdr){
  ...
  flow <- data.frame()
  #flow <- data.frame(matrix(ncol = 10, nrow = 0))
  #colnames(flow) <- c('name', 'namespace', 'rootEntityType', 
  #                  'methodRepoMethod.methodName', 'methodRepoMethod.methodVersion', 
  #                  'methodRepoMethod.methodNamespace', 'methodRepoMethod.methodUri', 
  #                  'methodRepoMethod.sourceRepo', 'methodRepoMethod.methodPath', 
  #                  'workspace_key')
